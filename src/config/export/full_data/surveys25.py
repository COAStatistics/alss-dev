...
from apps.surveys25.models import Survey, AgeScope, SAMPLE_GROUP
...
class SurveyRelationGeneratorFactory113:
    ...
    def __init__(self, filters={}, excludes={}, limit=None):
        ...
        self.surveys = (
            ...
            .prefetch_related(
                ...
                "hire_channels__item",
                "lack_responses",
                "lack_responses__item",
                "max_hourly_pays",
                "max_hourly_pays__item",
            )
        )
...
class SurveyExportor:
    def __init__(self, age_scopes, survey):
        ...
        self.blocks = [
            ...
            ReportBlock(
                generator=self.normal_relation_generate("hire_channels", ["item__name"]),
                start_col=82,
                end_col=82,
                silence=self.survey.page > 1,
            ),
            ReportBlock(
                generator=self.normal_relation_generate("lack_responses", ["item__name"]),
                start_col=83,
                end_col=83,
                silence=self.survey.page > 1,
            ),
            ReportBlock(
                generator=self.normal_relation_generate("max_hourly_pays", ["item__name"]),
                start_col=84,
                end_col=84,
                silence=self.survey.page > 1,
            ),
    ...
    def hire_generate(self):
        yield ["1" if self.survey.hire else "0"]
    ...
    def reviewer_generate(self):
        yield [
            ...
            (
                "N/A" if not hasattr(self.survey, "farmer_stat")
                else ("1" if self.survey.farmer_stat.sample_group == SAMPLE_GROUP.origin else "0")
            )
        ]
