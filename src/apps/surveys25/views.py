...
class Surveys2025Index(LoginRequiredMixin, TemplateView):
    login_url = "/users/login/"
    redirect_field_name = "redirect_to"
    template_name = "surveys25/index.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        context["hire_channel_items"] = HireChannelItem.objects.all()
        context["lack_response_items"] = LackResponseItem.objects.all()
        context["max_hourly_pay_items"] = MaxHourlyPayItem.objects.all()

        # ui elements
        ui = {
            "cropmarketing": render_to_string(
                "surveys25/row-ui/crop-marketing.html", context
            ),
            "livestockmarketing": render_to_string(
                "surveys25/row-ui/livestock-marketing.html", context
            ),
            "population": render_to_string("surveys25/row-ui/population.html", context),
            "longtermhire": render_to_string(
                "surveys25/row-ui/long-term-hire.html", context
            ),
            "longtermlack": render_to_string(
                "surveys25/row-ui/long-term-lack.html", context
            ),
            "shorttermhire": render_to_string(
                "surveys25/row-ui/short-term-hire.html", context
            ),
            "shorttermlack": render_to_string(
                "surveys25/row-ui/short-term-lack.html", context
            ),
            "nosalaryhire": render_to_string(
                "surveys25/row-ui/no-salary-hire.html", context
            ),
            "foreignlaborhire": render_to_string(
                "surveys25/row-ui/foreign-labor-hire.html", context
            )
        }
...
class ContentTypeViewSet(ReadOnlyModelViewSet, StandardViewSet):
    ...
    def get_queryset(self):
        return self.queryset.filter(
            Q(app_label="surveys25", model="longtermhire")
            | Q(app_label="surveys25", model="shorttermhire")
        )
