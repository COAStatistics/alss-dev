...
NUMBER_WORKERS_CHOICES = Q(app_label="surveys25", model="longtermhire") | Q(
...
class Survey(Model):
    ...
    lacks = ManyToManyField(
        "surveys25.Lack", blank=True, related_name="surveys", verbose_name=_("Lack")
    )
    ...
    review_logs = GenericRelation(ReviewLog, related_query_name="surveys25")
    # new field add in 24
...
class LongTermHire(Model):
    ...
    number_workers = GenericRelation(
        "surveys25.NumberWorkers", related_query_name="long_term_hires"
    )
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
...
class ShortTermHire(Model):
    ...
    number_workers = GenericRelation(
        "surveys25.NumberWorkers", related_query_name="short_term_hires"
    )
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
...
class NumberWorkers(Model):
    ...
    content_type = ForeignKey(
        ...
        on_delete=CASCADE,
        related_name="surveys25_number_workers",
    )
...
class Subsidy(Model):
    ...
    Table 4
    New fields:
        hire_channels, hire_channel_extra (4.2)
        lack_responses, lack_response_extra (4.3)
        max_hourly_pays, max_hourly_pay_extra (4.4)
    """
...
class HireChannel(Model):
    ...
    item = ForeignKey(
        ...
        blank=True,
        on_delete=CASCADE,
        related_name="hire_channel",
        verbose_name=_("Hire Channel Item"),
    )
    extra = CharField(max_length=50, null=True, blank=True, verbose_name=_("Extra"))
    update_time = DateTimeField(
        auto_now=True,
    ...
    class Meta:
        ...
        verbose_name_plural = _("Hire Channel")

    def __str__(self):
        return str(self.survey)


class HireChannelItem(Model):
    """
    Table 4.2 (new in 25)
    Option
    Has yaml
    ...
    name = CharField(max_length=50, null=True, blank=True, verbose_name=_("Name"))
    has_extra = BooleanField(default=False, verbose_name=_("Has Extra"))
    has_channel = BooleanField(default=True, verbose_name=_("Has Channel"))
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
        null=True,
    ...
    class Meta:
        verbose_name = _("Hire Channel Item")
        verbose_name_plural = _("Hire Channel Item")

    def __str__(self):
        return str(self.name)


class LackResponse(Model):
    """
    Table 4.3 (new in 24)
    """
    ...
    item = ForeignKey(
        ...
        blank=True,
        on_delete=CASCADE,
        related_name="lack_response",
        verbose_name=_("Lack Response Item"),
    )
    extra = CharField(max_length=50, null=True, blank=True, verbose_name=_("Extra"))
    update_time = DateTimeField(
        auto_now=True,
    ...
    class Meta:
        ...
        verbose_name_plural = _("Lack Response")

    def __str__(self):
        return str(self.survey)


class LackResponseItem(Model):
    """
    Table 4.3 (new in 25)
    Option
    Has yaml
    ...
    name = CharField(max_length=50, null=True, blank=True, verbose_name=_("Name"))
    has_extra = BooleanField(default=False, verbose_name=_("Has Extra"))
    has_response = BooleanField(default=True, verbose_name=_("Has Response"))
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
        null=True,
    ...
    class Meta:
        verbose_name = _("Lack Response Item")
        verbose_name_plural = _("Lack Response Item")

    def __str__(self):
        return str(self.name)


class MaxHourlyPay(Model):
    """
    Table 4.4 (new in 24)
    """
    ...
    item = ForeignKey(
        ...
        blank=True,
        on_delete=CASCADE,
        related_name="max_hourly_pay",
        verbose_name=_("Max Hourly Pay Item"),
    )
    extra = CharField(max_length=50, null=True, blank=True, verbose_name=_("Extra"))
    update_time = DateTimeField(
        auto_now=True,
    ...
    class Meta:
        ...
        verbose_name_plural = _("Max Hourly Pay")

    def __str__(self):
        return str(self.survey)


class MaxHourlyPayItem(Model):
    """
    Table 4.4 (new in 25)
    Option
    Has yaml
    ...
    name = CharField(max_length=50, null=True, blank=True, verbose_name=_("Name"))
    has_extra = BooleanField(default=False, verbose_name=_("Has Extra"))
    has_pay = BooleanField(default=True, verbose_name=_("Has Pay"))
    update_time = DateTimeField(
        auto_now=True,
        auto_now_add=False,
        null=True,
    ...
    class Meta:
        verbose_name = _("Max Hourly Pay Item")
        verbose_name_plural = _("Max Hourly Pay Item")
